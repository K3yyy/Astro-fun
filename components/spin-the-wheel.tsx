...
const wheelCategories = {
    ...
    food : [
        ...
        { text: "Steak", emoji: "🥩", color: "from-red-600 to-red-700" },
        { text: "Fries", emoji: "🍟", color: "from-yellow-400 to-yellow-500" },
        { text: "Ramen", emoji: "🍜", color: "from-orange-400 to-orange-500" },
        { text: "Chocolate", emoji: "🍫", color: "from-amber-600 to-amber-700" },
        { text: "Bread with Tacos", emoji: "🥪", color: "from-yellow-400 to-orange-500" },
        { text: "Dry Noodle", emoji: "🍝", color: "from-amber-400 to-red-500" },
        { text: "Spicy Noodle", emoji: "🌶️", color: "from-red-500 to-orange-500" },
        { text: "Chinese Noodle", emoji: "🥢", color: "from-yellow-400 to-red-500" },
        { text: "Soup", emoji: "🥣", color: "from-orange-400 to-yellow-400" },
        { text: "Chi Xuan", emoji: "🥡", color: "from-red-400 to-pink-500" },
    ],
    punishment : [
        ...
        { text: "Run in Place 1 Min", emoji: "🏃‍♂️", color: "from-red-400 to-red-500" },
        { text: "Do 15 Squats", emoji: "🦵", color: "from-purple-400 to-purple-500" },
        { text: "Take a Funny Selfie", emoji: "🤳", color: "from-pink-400 to-pink-500" },
    ],
    truthOrDare : [
        ...
        { text: "Truth: Your Crush?", emoji: "💌", color: "from-pink-400 to-red-400" },
        { text: "Dare: Speak in Accent", emoji: "🗣️", color: "from-purple-400 to-purple-500" },
        { text: "Truth: Embarrassing Moment", emoji: "😳", color: "from-yellow-400 to-orange-400" },
        { text: "Dare: Try Funny Pose", emoji: "🤸", color: "from-green-400 to-green-500" },
    ],
}
